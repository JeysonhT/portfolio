...
const technologies = [
  ...
  { name: "Astro", icon: SiAstro, color: "#FF5A1F" },
  { name: "Tailwind CSS", icon: SiTailwindcss, color: "#06B6D4" },
  { name: "Node.js", icon: SiNodedotjs, color: "#5FA04E" },
  { name: "Express.js", icon: SiExpress, color: "#000000" },
  { name: "Nest.js", icon: SiNestjs, color: "#EA285C" },
...
export const TechCarousel = () => {
  return (
    <div className="relative overflow-hidden py-10 w-full">
      ...
      <div className="absolute inset-0 bg-linear-to-r from-transparent via-indigo-50/30 to-transparent pointer-events-none" />
